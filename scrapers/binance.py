...
def main():
    ...
    # Get response
    response = requests.get("https://api.binance.com/api/v3/depth?symbol=BTCBUSD&limit=5000").json()
    ...
    # Save dataframe
    path = os.getcwd()
    name_long_df = path + "/order_books/binance/" + exchange_name + "_" + timestamp + ".csv"
